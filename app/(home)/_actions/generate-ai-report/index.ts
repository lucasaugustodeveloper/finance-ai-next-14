...
export const generateAiReport = async ({ month }: GenerateAiReportSchema) => {
  ...
  // send transactions for ChatGTP and request generate report with insights
  const content = `Gere um relatório com insights sobre as minhas finanças, com dicas e orientações de como melhorar
  minha vida financeira. As transações estão divididas por ponto e vírgula.
  ...
  // get report of ChatGTP and return for user
